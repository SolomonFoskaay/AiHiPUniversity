...
### ✅ Intro To AiHiPUniversity Platform
...
## 👽️ Recomended - CODING AI Support Tools
...
### 📚 3. Understand best practices building AI Chatbot
...
### 📚 5. Deciding web development techstack to use
...
I intentionally did not cut away the update box part of the terminal message above because it doesn't display it always but whenever you are installing or setting up new `node package` with `pnpm` and see  the update box similar to this above `Update available! 7.24.3 → 7.25.0.`,
...
As devs we always look for easier way out for boring repititve task 1000% of times✅.
...
Incase you are too lazy to write code comments when coding (don't know why though🙈),
...
Gbam💥 you done with a well commented code without writting a single line of comment yourself.

What a lazy🏗️ way to be a developer - but anyways its AI world - ENJOY🤡!
